...
MIDDLEWARE = [
    ...
    # "django.middleware.security.SecurityMiddleware",                # for deploymentz
...
# Set USE_SQLITE=True in .env for easy local development (no PostgreSQL needed)
# Set USE_SQLITE=False (or remove it) to use PostgreSQL
